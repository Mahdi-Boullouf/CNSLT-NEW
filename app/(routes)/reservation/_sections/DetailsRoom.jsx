  ...
  return (
    <div className="mt-24">
      <div className="my-4">
        ...
        <div className="text-black font-semibold text-xl font-raleway">
          {room?.name}
        </div>
        <div className="flex justify-between text-gray-500 my-2 space-x-6">
          <div className="flex items-center space-x-2 sm:flex-col sm:items-start sm:justify-center">
            ...
            <div className="underline decoration-1">
              <span className="font-bold uppercase border-l border-gray-300 px-2">
                {room?.areaId?.name}
              </span>
            </div>
          </div>
      ...
      <div className="w-full h-80  grid grid-cols-4 sm:grid-cols-2 grid-rows-2 sm:grid-rows-4 rounded-lg gap-2 relative">
        {[0, 1, 2, 3, 4].map((index) => (
          <div
            ...
            className={`${
              index === 0
                ? "row-span-2 col-span-2 sm:col-span-2 sm:row-span-2  "
      ...
      >
        <DialogContent className="rounded-lg">
          <div className="grid flex-1 gap-2 m-4">
            ...
            <Input id="link" defaultValue={pathName} readOnly />
          </div>
        </DialogContent>
      </Dialog>
      ...
      <Dialog
        ...
        className="bg-opacity-40  w-10/12 "
      >
          ...
          <Carousel className="  w-full   h-96 bg-opacity-40">
            <CarouselContent className="bg-opacity-40 ">
              {room?.images?.map((image, index) => (
                <CarouselItem
                  className="flex justify-center basis-1/2 sm:basis-1"
                  key={index}
                >
                  <img
                    className=" h-96 "
